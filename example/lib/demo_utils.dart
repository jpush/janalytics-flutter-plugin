...
class DemoUtils {
  ...
  static Widget createButton(String text, VoidCallback onPressed) {
    return new SizedBox(
  ...
  static void onCountEvent() {
    ...
    janalytics.onCountEvent("test_countID $eventIdIndex", // 事件ID
        extMap: extraMap);
    eventIdIndex++;
  }
